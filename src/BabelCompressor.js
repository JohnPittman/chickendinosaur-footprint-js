...
var UseStrictCompressor = require('./UseStrictCompressor');

function BabelCompressor() {
    this._headers = {
        // Minified versions
        exports: 'Object.defineProperty(exports,"__esModule",{value:!0});',
        interop: 'var _interopRequireDefault=function(a){return a&&a.__esModule?a:{"default":a}};',
        classCallCheck: 'var _classCallCheck=function(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function")};',
        createClass: 'var _createClass=function(){function a(a,b){for(var c=0;c<b.length;c++){var d=b[c];d.enumerable=d.enumerable||!1,d.configurable=!0,"value"in d&&(d.writable=!0),Object.defineProperty(a,d.key,d)}}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}();',
        get: 'var _get=function(a,b,c){for(var d=!0;d;){h=i=j=void 0,d=!1;var e=a,f=b,g=c,h=Object.getOwnPropertyDescriptor(e,f);if(void 0!==h){if("value"in h)return h.value;var j=h.get;return void 0===j?void 0:j.call(g)}var i=Object.getPrototypeOf(e);if(null===i)return void 0;a=i,b=f,c=g,d=!0}};',
        inherits: 'var _inherits=function(a,b){if("function"!=typeof b&&null!==b)throw new TypeError("Super expression must either be null or a function, not "+typeof b);a.prototype=Object.create(b&&b.prototype,{constructor:{value:a,enumerable:!1,writable:!0,configurable:!0}}),b&&(a.__proto__=b)};'
    };
    ...
    this.compress = function(text) {
        ...
        this._findExpressions(convertedText);

        for (var i = 0, n = this._implementedHeaders.length; i < n; ++i) {
            var headerType = this._implementedHeaders[i];
            // versions
            var versions = this._expressions[headerType];
            for (var j = 0, nn = versions.length; j < nn; ++j) {
                convertedText = convertedText.replace(versions[j], '');
            }

            // apply header
            convertedText = this._headers[headerType] + convertedText;
        }

        // use strict
        convertedText = UseStrictCompressor.compress(convertedText);
...
module.exports = new BabelCompressor();
